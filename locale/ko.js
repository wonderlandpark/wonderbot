...
module.exports = {
    ...
    commands : {
        ...
        payday : {
            cooldown : '쿨타임중입니다.\n`{time}`분 후에 사용가능합니다.',
            success : '당신의 잔고에 `100` <:coin:636879213239992330>을 추가했습니다!\n잔고 : `{money}` <:coin:636879213239992330>',
            premium : '당신의 잔고에 `100` <:coin:636879213239992330>을 추가했습니다!\n__원더봇 프리미엄__을 가입하셨군요! `100` <:coin:636879213239992330>을 추가지급합니다!\n잔고 : `{money}` <:coin:636879213239992330>'
        },
        allin : {
            ask : '정말로 올인 하시겠습니까? 실패시 모든 돈을 잃습니다. 성공시 현재 금액의 2배를 지급합니다\n계속하시려면 💸 반응을 눌러주세요',
            start : '올인을 시작합니다. 모두 잃거나 2배로 돈이 늘어나거나! 확률은 1/2 !',
            then : '돈을 올인 기계에 넣고 버튼을 눌렀습니다!',
            success : '인.생.역.전! `성공` 입니다!! \n돈이 {mul}배로 늘어납니다! [{n}회 연속 성공 보상]\n잔고 : `{money}`',
        ...
        slot : {
            ...
            ready : '{money} <:coin:636879213239992330>을 지불하고 슬롯머신을 돌리시겠습니까?\n계속하시려면 🎰로 반응하세요.\n원활한 사용을 위해서는 **Discord 창이 활성화 상태라면 자동으로 GIF 재생하기. ** 항목을 허용해주세요.',
            payed : '{money} <:coin:636879213239992330>을 지불했습니다!\n슬롯머신을 돌렸습니다!',
            res : '{plus} <:coin:636879213239992330> 이득 - {bet} <:coin:636879213239992330> 배팅 = {money}'
        },
        readnum : {
