CREATE TABLE `users` ( `id` TEXT NOT NULL  , `join` INT NOT NULL , `money` INT NOT NULL DEFAULT '0' , `money_cooldown` INT NOT NULL DEFAULT '0' , `badges` TEXT NOT NULL DEFAULT '[]', `items` TEXT NOT NULL DEFAULT "{}", `multiples` INT NOT NULL DEAFULT 0, `language` TEXT NOT NULL DEFAULT "ko", `cooldown` TEXT NOT NULL DEFAULT "{}", `action` BOOLEAN NOT NULL DEFAULT false, `mails` TEXT NOT NULL DEFAULT "[]");
