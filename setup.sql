CREATE TABLE `users` ( `id` TEXT NOT NULL  , `join` INT NOT NULL , `money` INT NOT NULL DEFAULT '0' , `money_cooldown` INT NOT NULL DEFAULT '0' , `badges` TEXT NOT NULL DEFAULT '[]', `items` TEXT NOT NULL DEFAULT '{}', `multiples` INT NOT NULL DEFAULT 0, `language` TEXT NOT NULL DEFAULT 'ko', `cooldown` TEXT NOT NULL DEFAULT '{}', `action` BOOLEAN NOT NULL DEFAULT false, `mails` TEXT NOT NULL DEFAULT '[]', `lotto` TEXT NOT NULL DEFAULT '{}');
CREATE TABLE `guilds` (`id` TEXT NOT NULL, `boost` INT NOT NULL DEFAULT 0, `config` TEXT NOT NULL DEFAULT '{"warncount": 7}', `warn` TEXT NOT NULL DEFAULT '{}');
...
CREATE TABLE `lotto` ( `id` INT NOT NULL , `date` INT NOT NULL, `numbers` TEXT NOT NULL DEFAULT '[]' , `prize` INT NOT NULL DEFAULT 0);
...
CREATE TABLE `info` (`stock` INT NOT NULL DEFAULT 0, `disaster` LONGTEXT NOT NULL DEFAULT '{}', `lotto` INT NOT NULL DEFAULT 0);
CREATE TABLE `shards` (`id` INT NOT NULL, `lastupdate` INT NOT NULL DEFAULT 0, `guilds` INT NOT NULL DEFAULT 0, `users` INT NOT NULL DEFAULT 0, `memory` INT NOT NULL DEFAULT 0, `ping` INT NOT NULL DEFAULT 0);
