module.exports.execute = async (
  ...
  await user.ban(locale.commands.ban.why.bind({reason: message.data.arg2 ? message.data.arg2 : locale.commands.ban.none, by: message.author.tag}))
    ...
    embed.addField(locale.commands.ban.mod, locale.commands.ban.modDesc.bind({mod: message.author, tag:  message.author.tag}))
    embed.addField(locale.commands.ban.user, locale.commands.ban.userDesc.bind({user: user.user, tag: user.user.tag}))
    embed.addField(locale.commands.ban.reason, locale.commands.ban.reasonDesc.bind({reason: message.data.arg2 ? message.data.arg2 : locale.commands.ban.none }))
    message.reply(embed)
