...
module.exports.execute = async (
  ...
  var channel = el.channels.filter(c => c.type == 'text' && (c.name.includes('공지') || c.name.includes('notice') || c.name.includes('원더봇') || c.name.includes('알림') || c.name.includes('announcement')) && !(c.topic !== null && c.topic.includes('NONOTICE')));
  if (channel.first()) {
