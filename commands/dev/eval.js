module.exports.execute = async (client, message, locale, embed, tools, knex, props, data) => {
    ...
    message.reply('Evaling...')
    .then(async m=>{
    const result = new Promise((resolve, reject) =>  resolve(eval(message.data.args)))
    ...
    return result.then(output => {
      ...
      if (output.length > 1010) console.log(output), output = output.slice(0, 1010)+'\n...'
