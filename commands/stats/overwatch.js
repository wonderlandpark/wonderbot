      ...
      .then(async profile => {
        ...
        profile.ratings.forEach(el => rank[el.role] = el);
          ...
          if (profile[gamemode].games) {
            ...
            if (heros[0]) embed.addField(tools.lib.emojis[heros[0].name] + ' ' + locale.commands.overwatch.heros[heros[0].name], locale.commands.overwatch.stat[gamemode].bind({ win: heros[0].data.game.gamesWon || heros[0].data.game.gameWon, lost: heros[0].data.game.gamesLost || heros[0].data.game.gameLost, percent: heros[0].data.game.winPercentage, kd: heros[0].data.average.eliminationsPerLife, objectTime: heros[0].data.average.objectiveTimeAvgPer10Min, fire: heros[0].data.average.objectiveTimeAvgPer10Min, eliminations: heros[0].data.combat.eliminations, deaths: heros[0].data.combat.deaths || heros[0].data.combat.death, playtime: heros[0].data.game.timePlayed }), true);
            if (heros[1]) embed.addField(tools.lib.emojis[heros[1].name] + ' ' + locale.commands.overwatch.heros[heros[1].name], locale.commands.overwatch.stat[gamemode].bind({ win: heros[1].data.game.gamesWon || heros[1].data.game.gameWon, lost: heros[1].data.game.gamesLost || heros[1].data.game.gameLost, percent: heros[1].data.game.winPercentage, kd: heros[1].data.average.eliminationsPerLife, objectTime: heros[1].data.average.objectiveTimeAvgPer10Min, fire: heros[1].data.average.objectiveTimeAvgPer10Min, eliminations: heros[1].data.combat.eliminations, deaths: heros[1].data.combat.deaths || heros[1].data.combat.death, playtime: heros[1].data.game.timePlayed }), true);
            ...
            if (heros[3]) embed.addField(tools.lib.emojis[heros[3].name] + ' ' + locale.commands.overwatch.heros[heros[3].name], locale.commands.overwatch.stat[gamemode].bind({ win: heros[3].data.game.gamesWon || heros[3].data.game.gameWon, lost: heros[3].data.game.gamesLost || heros[3].data.game.gameLost, percent: heros[3].data.game.winPercentage, kd: heros[3].data.average.eliminationsPerLife, objectTime: heros[3].data.average.objectiveTimeAvgPer10Min, fire: heros[3].data.average.objectiveTimeAvgPer10Min, eliminations: heros[3].data.combat.eliminations, deaths: heros[3].data.combat.deaths || heros[3].data.combat.death, playtime: heros[3].data.game.timePlayed }), true);

          } else {
            embed.addField(locale.commands.overwatch.noinfo, locale.commands.overwatch.nogamemode);
          }
          } else {
